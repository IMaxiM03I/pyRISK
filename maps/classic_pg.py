...
nAmerican_terr: dict[str: Territory] = {
    ...
    "nw territory": Territory(name="Northwest Territory", neighbours=["alaska", "alberta", "ontario", "greenland"],
                              x=146, y=75),
    ...
    "ontario": Territory(name="Ontario", neighbours=["alberta", "nw territory", "greenland", "quebec", "w us", "e us"],
                         x=190, y=130),
    "quebec": Territory(name="Quebec", neighbours=["ontario", "greenland", "e us"], x=250, y=135),
    "w us": Territory(name="Western United States", neighbours=["alberta", "ontario", "e us", "central america"], x=105,
                      y=185),
    "e us": Territory(name="Eastern United States", neighbours=["w us", "ontario", "quebec", "central america"], x=178,
                      y=204),
...
european_terr: dict[str: Territory] = {
    ...
    "ukraine": Territory(name="Ukraine",
                         neighbours=["n europe", "scandinavia", "ural", "afghanistan", "middle e", "s europe"], x=540,
                         y=160),
    "gb": Territory(name="Great Britain", neighbours=["iceland", "scandinavia", "n europe", "w europe"], x=368, y=170),
    "n europe": Territory(name="Northern Europe", neighbours=["gb", "scandinavia", "ukraine", "s europe", "w europe"],
                          x=456, y=178),
    "w europe": Territory(name="Western Europe", neighbours=["gb", "n europe", "s europe", "n africa"], x=383, y=250),
    "s europe": Territory(name="Southern Europe",
                          neighbours=["w europe", "n europe", "ukraine", "middle e", "egypt", "n africa"], x=470, y=234)
}

# africa #
african_terr: dict[str: Territory] = {
    "n africa": Territory(name="North Africa",
                          neighbours=["brazil", "w europe", "s europe", "egypt", "e africa", "congo"], x=412, y=364),
    "egypt": Territory(name="Egypt", neighbours=["n africa", "s europe", "middle e", "e africa"], x=494, y=330),
    "e africa": Territory(name="East Africa",
                          neighbours=["n africa", "egypt", "madagascar", "middle e", "s africa", "congo"], x=558,
                          y=426),
...
asian_terr: dict[str: Territory] = {
    ...
    "mongolia": Territory(name="Mongolia", neighbours=["siberia", "irkutsk", "kamchatka", "japan", "china"], x=784,
                          y=185),
    "kamchatka": Territory(name="Kamchatka", neighbours=["irkutsk", "yakutsk", "alaska", "japan", "mongolia"], x=846,
                           y=74),
    "japan": Territory(name="Japan", neighbours=["mongolia", "kamchatka"], x=888, y=190),
    "afghanistan": Territory(name="Afghanistan", neighbours=["ukraine", "ural", "china", "india", "middle e"], x=634,
                             y=205),
    "china": Territory(name="China", neighbours=["afghanistan", "ural", "siberia", "mongolia", "siam", "india"], x=756,
                       y=242),
    "middle e": Territory(name="Middle East",
                          neighbours=["egypt", "s europe", "ukraine", "afghanistan", "india", "e africa"], x=572,
                          y=310),
...
aussie_terr: dict[str: Territory] = {
    ...
    "w australia": Territory(name="Western Australia", neighbours=["indonesia", "new guinea", "e australia"], x=850,
                             y=556),
...
CLASSIC_MAP = pg.image.load(r'.\maps\classic_map_v1-1_resized.png')
